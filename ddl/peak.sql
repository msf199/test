CREATE TABLE `user` (
...
) ENGINE=InnoDB AUTO_INCREMENT=11947 DEFAULT CHARSET=utf8;CREATE TABLE `avcpvm_monitoring` (
  ...
  `content_url_original` varchar(255) DEFAULT NULL,
  ...
  `video_length_seconds` int(5) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1662 DEFAULT CHARSET=utf8;CREATE TABLE `order` (
...
) ENGINE=InnoDB AUTO_INCREMENT=30805 DEFAULT CHARSET=utf8;CREATE TABLE `bundle_match` (
...
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8;CREATE TABLE `content_comments` (
