...
public class StaticRules {
    ...
    public enum ErrorCodes {
        ...
        BECOME_PUBLISHER_MESSAGE(181, "An email has been sent to our head of marketing to review your request to become a publisher! Feel free to watch videos in the meantime :)", HttpStatus.UNAUTHORIZED_401);
