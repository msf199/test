    ...
    public void send() {
        ...
        try {
            ...
            if (me != null) {
                ...
                UserNotification n = new UserNotification(me.getUserId(), "Welcome to "+Config.PLATFORM_NAME+"!", "open-content:" + Config.INTRO_CONTENT_ID, Config.PLATFORM_THUMBNAIL_URL);
