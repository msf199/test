 ...
 */
public class AndroidMassNotification extends EndpointHandler {
    ...
    public void safeCall(final RequestObject context) throws IOException {
         ...
         */
        Server.NotificationService.offerNotification(new MassNotification(text, Config.ANDROID_DEVICE_TYPE_ID));
